...
export function TodayProgressCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--bg-surface)] p-6 shadow-xs transition-border hover:border-[var(--border-strong)]">
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-3 self-start md:self-auto">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[var(--border)] bg-[var(--bg-base)] text-xs font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--border-strong)] shadow-xs active:scale-95 disabled:opacity-50 cursor-pointer"
